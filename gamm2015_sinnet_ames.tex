...
\begin{figure}
  ...
  \includegraphics[width=0.25\columnwidth]{compass-gait} \hspace{3em}
...
%\begin{figure}[t!]
%  \centering
%  \includegraphics[width=0.49\columnwidth]{hybrid_cart_spring_phase_portrait}
%  \includegraphics[width=0.49\columnwidth]{hybrid_cart_spring_es_phase_portrait}
%  \caption{%
%    Phase portrait for a simulation of a nominal cart--spring system (left) and
%    shaped system (right).%
%  }
%  \label{fig:cart_spring_simulation}
%\end{figure}
